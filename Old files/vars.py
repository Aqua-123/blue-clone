...
fallback_check = ["20909261", "16008266"]

greet_exempt = ["20909261", "20909232"]
...
aichatstate = False
cookies = {
    "_prototype_app_session":
        "%3D%3D--83ddb608f55747654feca4873dff6895e55b263e"
}
# Custom greets
custom_greet_id = {
    "16986137":
        "The river of life bubbles when Aqua comes near~ ",
    "21550262":
        "Hi, its Blue ^-^",
    "21388579":
        "Sir This recruit tactically acquired the fig bars sir~",
    "20835136":
        "Testing, testing, Wan, two, three! ",
    "291734":
        "Here comes our favorite magical frog! 🐸 ~~.*~",
    "14751444":
        "Hamtaro, the karmic wonder, has arrived ·ᴗ·",
    "18695559":
        "Your friendly neighbourhood Saturn is here! *~~.",
    "18274541":
        "A buzzy Bee enters the hive! 🐝 ~~.*~",
    "18491422":
        "Shhhh... The one and only drama queen cat is here *meow* ",
    "18560513":
        "SCP-1689 would make for a lot of ... Chipz. ~*",
    "17248098":
        "The darker the night, the brighter the stars... ~*",
    "20909209":
        "A dude? B dude? what dude? which dude? what is A? what is dude? who am i? what is wfaf..... x-x",
    "19422865":
        "Twi, the cute pony is here ~*",
    "17979714":
        "Your local simp (Bri) is here ~*",
    "14648841":
        "こんにちはねこちゃん",
    "17364255":
        "Coming hot out of the oven, it's 𝖕𝖎𝖊! 🥧 *~~.",
    "21848509":
        "Megumin, the arch-wizard magically appears out of thin air 🧙",
    "19259507":
        "Greetings cathy cath ~*",
    "20073491":
        "Greetings, your highness *bows*",
    "20909261":
        "Mecha nurse is here, everyone get ready for your shots 💉 💊 ",
    "22466125":
        "Welcome lovely person <3",
    "21842289":
        "As dusk appears, darkness takes over the sky... before the last trace of light is gone",
    "11427049":
        "Personal pizzas all around! Harenoir has arisen from the void!",
    "16008266":
        "The most radiant & shining greeter has arrived! <3",
    "22975867":
        "The earth shalt trem'r at which hour the sphere rolls to the did grind ",
    "20199174":
        "Your personal babygirl has entered the chat :wink:"
}
...
thanks = re.compile(
    r"""((thanks|thx|thenks|thonks|thank you) blue\s*)|(blue (thanks|thx|thenks|thonks|thank you)(\\n)*\s*)""",
    re.I)
smile = re.compile(r""":>(\\n)*\s*""", re.I)
...
stats1 = re.compile(r"""(blue stats)|(blue tell me the stats)(\\n)*\s*$""",
                    re.I)
get_mute = re.compile(
    r"""(blue get mutelist)|(blue fetch mutelist)(\\n)*\s*$""", re.I)
...
coinsandfeelings = [coins, loves, pat, hug, bonk, get_id, get_karma]
...
check1 = re.compile(
    r"""Welcome, [^""]+, to WFAF - Waiting For A Friend. This is a family-friendly group chat you get sent to when you try to message someone who you've sent a friend request to and they haven't accepted your request.\s*"""
)
check2 = re.compile(
    r"""Hi, [^""]+, retrying won't help, you can try asking 'what is wfaf' for more info :D\s*"""
)
check3 = re.compile(
    r"""Hi again, [^""]+, try asking 'what is wfaf' for more info :D\s*""")
check4 = re.compile(
    r"""Hello, [^""]+! Welcome to WFAF! - Waiting for a Friend! The place where your dreams used to come true~\s*"""
)
check5 = re.compile(
    r"""Hi, [^""]+! I'm afraid they aren't your friend yet, you can always try again!\s*"""
)
check6 = re.compile(
    r"""Hi again, [^""]+, don't feel bad, they'll accept one day... hopefully!\s*"""
)
